...
export const Route = createFileRoute("/nicolas-xii")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portrait anonyme du gardien suprême de l'estragon. Économiste le matin, mystique aromatique en permanence." },
      { property: "og:title", content: "Nicolas XII — Le gardien" },
      { property: "og:description", content: "Économiste le matin, mystique aromatique en permanence." },
...
const facts = [
  ["Identité civile", "Protégée. Indice : il parle de marchés financiers avant 9h."],
  ["Premier brin consommé", "Vers 1987, dans une omelette de sa grand-mère. Choc fondateur."],
  ...
  ["Signe distinctif", "Une feuille séchée glissée dans la pochette de son veston."],
];
    ...
    <div className="min-h-screen flex flex-col">
        ...
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-20 items-start">
          ...
          <div className="lg:col-span-3">
            ...
            <p className="mt-8 text-lg text-foreground/80 leading-relaxed">
              ...
              les indices boursiers, expliquer les politiques monétaires, sourire
              poliment aux blagues de ses confrères. Ce qu'on ignore, c'est qu'à
              chacune de ses interventions, il porte sur lui — toujours — au
              moins <strong>douze brins d'estragon</strong>.
            </p>
            <p className="mt-5 text-foreground/80 leading-relaxed">
              Pas par superstition. Par <em>vocation</em>. Nicolas XII est le
              douzième d'une lignée secrète de gardiens de l'<em>Artemisia
              Dracunculus</em>, fondée — selon la tradition — en Provence au
              XVIᵉ siècle, par un cuisinier de cour exilé.
            </p>
      ...
      <section className="bg-secondary/40 border-y border-border">
        <div className="mx-auto max-w-4xl px-6 py-24 text-center">
          <div className="ornament smallcaps mb-6">Charrié — mais imperturbable</div>
          ...
          <p className="mt-8 text-lg text-muted-foreground leading-relaxed">
            En studio, ses collègues le taquinent. Sur les ondes, il sourit. Dans
            sa loge, à 9h05, il consulte ses pieds d'estragon par FaceTime depuis
            son rebord de fenêtre. Chacun son équilibre.
          </p>
        </div>
      </section>
